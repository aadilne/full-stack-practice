// ============================================================
// JAVASCRIPT MATH — COMPLETE TOPICS
// ============================================================
...
// Circle ke calculation me iska bahut use hota hai.

let mathPiValue = Math.PI;

console.log(mathPiValue);
// 3.141592653589793
...
// √(1/2)
//
// Iski value lagbhag 0.7071 hai.

let mathSqrtHalfValue = Math.SQRT1_2;

console.log(mathSqrtHalfValue);
...
// Important:
// Negative number me "neeche" ka matlab
// aur chhota number hota hai.
...
// fround() number ko 32-bit floating-point
// value me convert karta hai.
//
// Normal JavaScript Number 64-bit floating point hota hai.
// fround() 32-bit precision deta hai.

console.log(Math.fround(10.5));
// 10.5
...
// Iska use mainly special numeric calculations
// aur 32-bit floating-point data ke saath hota hai.
...
// sign() batata hai number positive,
// negative ya zero hai.
//
// Positive → 1
// Negative → -1
// Zero → 0
...
// Math.random() 0 se lekar 1 se chhota
// random decimal number deta hai.
//
// Example:
// 0.25
// 0.73
...
//
// Example:
// 0 se 9 tak random integer

let mathRandomIntegerValue =
    Math.floor(Math.random() * 10);

console.log(mathRandomIntegerValue);
// 0 se 9
...
let mathRandomRangeValue =
    Math.floor(
        Math.random() *
        (mathRandomRangeMax - mathRandomRangeMin + 1)
    ) + mathRandomRangeMin;

console.log(mathRandomRangeValue);
// 1 se 100
...
// IMPORTANT:
// Math.random() security ke liye strong nahi hai.
// Real login/security OTP ke liye
// secure random system use karna chahiye.
...
for (let mathColorLoopCount = 0; mathColorLoopCount < 6; mathColorLoopCount++) {
    ...
    let mathColorRandomIndex =
        Math.floor(
            Math.random() *
            mathRandomColorCharacters.length
        );

    mathRandomColorValue +=
        mathRandomColorCharacters[mathColorRandomIndex];
}
...
//
// Random index nikal rahe hain.

let mathRandomArrayIndex =
    Math.floor(
        Math.random() *
        mathRandomArrayItems.length
    );


// Random item:

let mathRandomArrayItem =
    mathRandomArrayItems[mathRandomArrayIndex];
...
// IMPORTANT:
// JavaScript ke sin(), cos(), tan()
// ANGLE ko RADIANS me lete hain.
//
...
let mathAtanTwoResult =
    Math.atan2(
        mathAtanTwoYValue,
        mathAtanTwoXValue
    );

console.log(mathAtanTwoResult);
// PI / 4
...
let mathPercentageResult =
    (mathPercentagePart / mathPercentageTotal) * 100;

console.log(mathPercentageResult);
// 75
...
let mathAverageResult =
    (
        mathAverageValueOne +
        mathAverageValueTwo +
        mathAverageValueThree
    ) / 3;

console.log(mathAverageResult);
// 80
...
let mathDiscountAmount =
    (
        mathDiscountOriginalPrice *
        mathDiscountPercent
    ) / 100;

console.log(mathDiscountAmount);
// 200


// Final price:

let mathDiscountFinalPrice =
    mathDiscountOriginalPrice -
    mathDiscountAmount;

console.log(mathDiscountFinalPrice);
// 800
...
let mathGstAmount =
    (
        mathGstOriginalPrice *
        mathGstPercent
    ) / 100;

console.log(mathGstAmount);
// 180


// GST ke baad final price:

let mathGstFinalPrice =
    mathGstOriginalPrice +
    mathGstAmount;

console.log(mathGstFinalPrice);
// 1180
...
let mathRectangleArea =
    mathAreaLength * mathAreaWidth;

console.log(mathRectangleArea);
// 50
...
let mathDistanceResult =
    Math.hypot(
        mathDistanceX,
        mathDistanceY
    );

console.log(mathDistanceResult);
// 5
...
let mathRandomProblemResult =
    Math.floor(
        Math.random() *
        (
            mathRandomProblemMax -
            mathRandomProblemMin +
            1
        )
    ) +
    mathRandomProblemMin;
...
// IMPORTANT:
// Math.random() real security OTP ke liye
// suitable nahi hai.
//
// Real application me secure random generator
// use karna chahiye.
...
let mathMinimumResult =
    Math.min(
        mathMinMaxValueOne,
        mathMinMaxValueTwo,
        mathMinMaxValueThree,
        mathMinMaxValueFour
    );

console.log(mathMinimumResult);
// 12


// Sabse bada:

let mathMaximumResult =
    Math.max(
        mathMinMaxValueOne,
        mathMinMaxValueTwo,
        mathMinMaxValueThree,
